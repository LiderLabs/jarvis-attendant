    ...
    content: (
      <div className="p-4 space-y-4">
        <div className="text-center mb-6">
          ...
          <p className="font-semibold text-foreground">Javis</p>
        </div>
    ...
    content: (
      <div className="p-4 text-center space-y-4">
        ...
        <div className="bg-muted/50 rounded-xl p-4 text-left">
          ...
          <p className="text-sm font-medium">Bring your clothes to Javis</p>
    ...
    content: (
      <div className="p-4 space-y-4">
        ...
        <button className="w-full flex items-center gap-3 p-4 rounded-xl border-2 border-primary bg-primary/5 text-left">
          ...
          <div>
            <p className="font-medium text-foreground">Pickup at Javis</p>
